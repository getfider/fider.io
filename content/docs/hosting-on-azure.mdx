...
```
postgres=> CREATE DATABASE fider;
```
...
- `DATABASE_URL`: postgresql://{your_postgres_server}.postgres.database.azure.com:5432/fider?user={your_username}@{your_postgres_server}&password={your_password}&sslmode=require
- `HOST_DOMAIN`: {your_appname}.azurewebsites.net
