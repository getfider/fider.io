...
<table>
  ...
  <tr>
    ...
    <td>**Required.** The subject of the email to be sent.</td>
  </tr>
  <tr>
    <td>
      <code>message</code>
    ...
    <td>
      **Required.** The content of the email to be sent. The message must include the <code>%invite%</code> placeholder, which will be replaced a secure
      invitation link.
    </td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td>**Required.** The list of email addresses to send an invite.</td>
  </tr>
  <tr>
    <td>
      <code>subject</code>
