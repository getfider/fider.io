...
<table>
  ...
  <tr>
    ...
    <td>
      <strong>Required.</strong> The subject of the email to be sent.
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td>
      <strong>Required.</strong> The content of the email to be sent. The message must include the <code>%invite%</code> placeholder, which will be replaced a
...
<table>
  ...
  <tr>
    ...
    <td>
      <strong>Required.</strong> The list of email addresses to send an invite.
    </td>
  </tr>
  <tr>
    <td>
