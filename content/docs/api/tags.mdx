...
<table>
  ...
  <tr>
    ...
    <td>
      <strong>Required.</strong> The display name of the tag.
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td>
      <strong>Required.</strong> The Hex color of the tag (without #).
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td>
      <strong>Required.</strong> <code>true</code> for public tags or <code>false</code> for private tags.
    </td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td>
      <strong>Required.</strong> The slug of the tag to be edited.
    </td>
  </tr>
  <tr>
    <td>
...
<table>
  ...
  <tr>
    ...
    <td>
      <strong>Required.</strong> The slug of the tag to be deleted.
    </td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td>
      <strong>Required.</strong> The number of the post to add the tag.
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td>
      <strong>Required.</strong> The slug of the tag to be added.
    </td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td>
      <strong>Required.</strong> The number of the post to remove the tag.
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td>
      <strong>Required.</strong> The slug of the tag to be removed.
    </td>
  </tr>
</table>
