...
<table>
  ...
  <tr>
    <td>Cloud</td>
    <td>
      <code>https://&lt;subdomain&gt;.fider.io</code> or, if configured, your custom domain name (e.g: <code>https://feedback.yourcompany.com</code>)
    </td>
    <td>HTTPS only</td>
  </tr>
  <tr>
...
<table>
  ...
  <tr>
    ...
    <td>
      Something is incorrect with your request, it might be missing a parameter or have an invalid value. See <strong>Error Messages</strong> below.
    </td>
  </tr>
  <tr>
    <td>403 Forbidden</td>
