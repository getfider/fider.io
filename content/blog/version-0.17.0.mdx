...
<figure>
  <img src="/images/blog/v0.17-voters-panel.png" className="h-20" />
</figure>
...
<figure>
  <img src="/images/blog/v0.17-members-page.png" />
</figure>
...
<figure>
  <img src="/images/blog/v0.17-block-user.png" />
</figure>
...
To know more about it, we wrote a in depth article on **how we reduced the bundle size by 67%**, you [can read it here](/blog/how-we-reduced-initial-jscss-size). Special thanks to [@cfilby](https://github.com/cfilby) for your help on implementing Code Splitting!
