...
<figure>
  <img src="/images/blog/v0.18-attach-image.png" className="h-96" />
</figure>
...
- feature: prerender crawler requests if rendergun is configured ([#724](https://github.com/getfider/fider/pull/))
